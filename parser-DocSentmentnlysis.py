#!/usr/bin/env python3
# coding: utf-8
# File: DocSentimentAnalyconda install -c conda-forge jupyterlabsis.py
...
parser.add_argument('content',type=str,help='get the input to judge')
args = parser.parse_args()
obj = Sentimentor()
score = obj.doc_sentiment_score(args.content)
print(f'The score of the input is: {score}')